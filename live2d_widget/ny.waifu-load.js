...
function loadWidget(config) {
    ...
    async function loadModel(modelId, modelTexturesId, message) {
        ...
        loadlive2dfix({
            canvasId   : "live2d"                                          ,
            configPath : `${apiPath}get/?id=${modelId}-${modelTexturesId}` ,
            modelPath  : cdnPath                                           ,
            headPos    : 0.5                                               ,
            callback   : ()=>{console.log("嘻嘻 我来啦！")},
        });
        console.log(`Live2D 模型 ${modelId}-${modelTexturesId} 加载中……`);
    }
...
!function ny_waifu_load() {
   setTimeout(() => {
       initWidget({
         waifuPath : "/live2d_widget/ny.waifu-tips.json",
         apiPath   : "https://yuanjiuzheng.com/live2d_api/",
         cdnPath   : "//cdn.jsdelivr.net/gh/Yerannnnnn/Yerannnnnn.github.io@master/live2d_api/model/",
       });
   }, 0);
}();
