...
LAppModel.prototype.load = function(gl, configPath, modelPath, callback)
{
...
LAppLive2DManager.prototype.changeModel = function (gl, configPath, modelPath,callback) {
  ...
  if (this.reloadFlg) {
    ...
    this.createModel();
    this.models[0].load(gl, configPath, modelPath,callback);
  }
};
...
let live2DMgr = new LAppLive2DManager();
...
function changeModel(configPath, modelPath,callback)
{
    live2DMgr.reloadFlg = true;
    live2DMgr.count++;
    live2DMgr.changeModel(gl,configPath, modelPath,callback);
}
...
function loadlive2d({
    ...
    init();
    changeModel(configPath, modelPath,callback);
    startDraw();
}

// ex api
function loadlive2dfix(option) {
    ny_css_fix = 1;
    loadlive2d(option);
}
